...
<p className='text-center text-sm '>New here? <Link to="/signup" className='text-blue-600'>Create new Account</Link></p>
      ...
      <div>
        <Link to="/captain-login" className='bg-[#10b461] flex mb-5 items-center justify-center text-white font-semibold rounded  px-4 py-2 border w-full text-lg '>Sign in as Captain</Link>
      </div>
    </div>
  )
}
